  ...
  factory CFormatException.fromCode(String code) {
    switch (code) {
      ...
      case 'invalid-url-format':
        return const CFormatException('The URL format is invalid. Please enter a valid URL.');
      case 'invalid-credit-card-format':
        return const CFormatException('The credit card format is invalid. Please enter a valid credit card number.');
      case 'invalid-numeric-format':
        return const CFormatException('The input should be a valid numeric format.');
